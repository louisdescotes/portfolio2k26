  ...
  return (
    <div className="about">
      <div className="about-header">
        <div className="animation-overflow">
          <motion.h1
            ...
            className="about-header-title type-80"
          >
            Hello
          </motion.h1>
        </div>
      ...
      <div className="about-description">
        <div className="about-description-me">
          <div className="animation-overflow">
            <motion.span
              initial={{ y: "100%" }}
              animate={{ y: 0 }}
        ...
        <div>
          <div className="about-others">
            <div className="about-others-services">
              <div className="animation-overflow">
                <motion.span
                  initial={{ y: "100%" }}
                  animate={{ y: 0 }}
              ...
              <ul className="about-others-services-detail">
            ...
            <div className="about-others-socials">
